...
//const bodyParser = require("body-parser"); //don't need to import body-parser is now part of express
...
app.post("/", function(req, res){
    console.log(logreq.body.cityName);
    //console.log("Post request receipt");
});
